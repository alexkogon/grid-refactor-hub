...
public class Hub implements HubInterface {
  ...
  /* (non-Javadoc)
   * @see org.openqa.grid.web.HubInterface#getRegistry()
   */
  @Override
  ...
  public Hub(GridHubConfiguration config) {
    ...
    try {
		...
		ObjectName objectName = new ObjectName("org.openqa.grid.selenium.grid.monitor:type=GridMonitor");
		GridMonitor gridMonitorMBean = new GridMonitor();
		mBeanServer.registerMBean(gridMonitorMBean, objectName);
		registry.setGridMonitorMBean(gridMonitorMBean);
  ...
  private void initServer() {
    try {
      ...
      root.setAttribute(HubRegistryInterface.KEY, registry);
  ...
  /* (non-Javadoc)
   * @see org.openqa.grid.web.HubInterface#getPort()
   */
  @Override
  public int getPort() {
    return port;
  ...
  /* (non-Javadoc)
   * @see org.openqa.grid.web.HubInterface#getHost()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see org.openqa.grid.web.HubInterface#start()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see org.openqa.grid.web.HubInterface#stop()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see org.openqa.grid.web.HubInterface#getUrl()
   */
  @Override
  public URL getUrl() {
    try {
  ...
  /* (non-Javadoc)
   * @see org.openqa.grid.web.HubInterface#getRegistrationURL()
   */
  @Override
